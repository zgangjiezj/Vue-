function Compile(el, vm) {
    // 保存vm到compile对象，this是compile实例对象
    this.$vm = vm;
    // 保存el元素 ---》el是元素节点存el，不是通过选择器查找对应的节点
...
Compile.prototype = {
    ...
    /* 
    编译指定element/fragment的【子节点】，通过递归调用，实现对所有层次子节点的编译处理
    */
    compileElement: function(el) { //el 是元素或者fragment
        // 得到fragment中所有子节点
        ...
        [].slice.call(childNodes).forEach(function(node) {
            ...
            // 定义正则用来匹配【插值语法】的正则对象，()为子匹配，匹配出来name，放入 RegExp.$1中
            var reg = /\{\{(.*)\}\}/;
            // 如果当前节点是元素节点
            ...
            // 如果是【插值语法格式】的【文本节点】
                ...
                // 编译文本节点（只有插值语法格式的要编译，通过正则判断插值格式）
